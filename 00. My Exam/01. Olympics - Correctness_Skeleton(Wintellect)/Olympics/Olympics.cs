...
public class Olympics : IOlympics
{
    ...
    public void Compete(int competitorId, int competitionId)
    {
        if (this.byCompetitorId.ContainsKey(competitorId) && this.byCompetitionId.ContainsKey(competitionId))
        {
            ...
            this.byCompetitionId[competitionId].Competitors.Add(this.byCompetitorId[competitorId]);
        }
        else
        {
            throw new ArgumentException();
    ...
    public bool Contains(int competitionId, Competitor comp)
    {
        ...
        {
            var competitors = this.byCompetitionId[competitionId].Competitors;
            var a = competitors.Contains(comp);
            return a;
        }
        throw new ArgumentException();
    }
