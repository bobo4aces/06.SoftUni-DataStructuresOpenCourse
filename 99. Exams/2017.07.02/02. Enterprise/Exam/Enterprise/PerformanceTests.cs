...
public class PerformanceTests
{
    ...
    public void changeUUIDExistingEmployeeCheckForData()
    {
        ...
        Assert.AreEqual("replaced", byUuid.FirstName);
        Assert.AreEqual("replacedEmployee", byUuid.LastName);
        Assert.AreEqual(555, byUuid.Salary, 0.00001);
    }
    ...
    public void insertEmployees_RaiseSalaries_CheckForNames()
    {
        ...
        {
            Assert.AreEqual(expected[idx++], employeesName);
        }
    }
}